...
public class BuggySSNHelperIncorrectFormatAdapter implements ISsnHelper {
    private final BuggySSNHelperIncorrectFormat impl = new BuggySSNHelperIncorrectFormat();
